...
public class HexFeatureManager : MonoBehaviour {
    ...
    )
    {
        if (
            ...
            if (hasRiver || hasRoad)
            {
                ...
                AddWallCap(far.v4, near.v4);    // switch orientation, face out
            }
            else
            {
    ...
    /*
     *  Add wall across triangular corner if cell is a pivot
     * 
     *             /-----\
     *            / right \
     *    /-----\ \       /
    ...
    void AddWallSegment (
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v1, v2, v3, v4);  // add a wall facing into our cell
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v2, v1, v4, v3);  // add another facing the neighbor cell

        walls.AddQuadUnperturbed(t1, t2, v3, v4);  // put a top on the wall
            ...
            if (hasRightWall) {
                ...
                if (leftCell.Elevation == rightCell.Elevation) {
                    HexHash hash = HexMetrics.SampleHashGrid(
                        (pivot + left + right) * (1f / 3f)  // center of corner
                    );
    ...
    public void AddBridge (Vector3 roadCenter1, Vector3 roadCenter2) {
        ...
        // scale length of bridge to adjust to perturbed terrain
